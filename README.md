...
9.  #### Run Functional Tests
    ...
    To then add additional test data as a second step run `$ bash run_tests.bash importDBs` (takes some time). Or run `$ bash run_tests.bash withImportDBs` to run all in one hit.

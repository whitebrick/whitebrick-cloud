Feature: Organizations
  ...
  Scenario: Create organizations
    * table organizations 
      ...
      | 'test_3-admins-org' | "3 Admins Org"  | 'test_donna@test.whitebrick.com'
  ...
  Scenario: Add users to organizations
    * table organizationUsers 
      ...
      | 'test_3-admins-org' | 'organization_administrator' | ["test_daisy@test.whitebrick.com", "test_debbie@test.whitebrick.com"]

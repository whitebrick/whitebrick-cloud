    ...
    setOrganizationUsersRole(organizationName, userEmails, role) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (usersResult.payload.length != userEmails.length) {
                return {
                    success: false,
                    message: `setOrganizationUsersRole: missing user(s): ${userEmails.filter((x) => !usersResult.payload.includes(x))}`,
                };
            }
